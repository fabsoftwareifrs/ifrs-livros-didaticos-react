...
const LoanDetails = ({ className, ...rest }) => {
  ...
  if (!loading) {
    values = { id: data.loan.id, studentId: parseInt(data.loan.student.id), copyId: parseInt(data.loan.copy.id), periodId: parseInt(data.loan.period.id) }
  }
                  ...
                  >
                    ...
                    {copies.loading ? "" :
                      <Autocomplete
                        ...
                        value={input.copyId.value == "" ? { value: "", label: "" } : { value: "" + input.copyId.value, label: copies.data.copies.find(s => s.id === "" + input.copyId.value).code }}
                  ...
                  >
                    {students.loading ? "" :
                      <Autocomplete
                        ...
                        value={input.studentId.value == "" ? { value: "", label: "" } : { value: "" + input.studentId.value, label: students.data.students.find(s => s.id === "" + input.studentId.value).name }}
                        getOptionLabel={(option) => option.label}
                        getOptionSelected={(option, value) => option.id === value.id}
                  ...
                  >
                    {periods.loading ? "" :
                      <Autocomplete
                        ...
                        value={input.periodId.value == "" ? { value: "", label: "" } : { value: "" + input.periodId.value, label: periods.data.periods.find(s => s.id === "" + input.periodId.value).name }}
                        getOptionLabel={(option) => option.label}
                        getOptionSelected={(option, value) => option.id === value.id}
